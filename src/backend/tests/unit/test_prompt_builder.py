...
def test_build_system_prompt_with_rag():
    ...
    system_prompt = PromptBuilder.build_system_prompt(
        personality_prompt=personality_prompt, rag_context=rag_context
    )
...
def test_build_system_prompt_with_api_module():
    ...
    personality_prompt = "You are a helpful assistant named Morgan."
    api_module_context = (
        "API MODULE RESULT: The current weather in Dublin is 15°C and partly cloudy."
    )

    # System prompt with API module context
    system_prompt = PromptBuilder.build_system_prompt(
        personality_prompt=personality_prompt, rag_context=api_module_context
    )
...
def test_build_system_prompt_with_tts():
    ...
    system_prompt = PromptBuilder.build_system_prompt(
        personality_prompt=personality_prompt, tts_instructions=tts_instructions
    )
