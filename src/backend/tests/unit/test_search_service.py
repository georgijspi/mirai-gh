...
# Import the module
from api.services.search_service import format_search_results_for_rag, clean_html
...
def test_clean_html():
    ...
    assert (
        clean_result == "This is bold text with a link ."
        or clean_result == "This is bold text with a link."
    )
