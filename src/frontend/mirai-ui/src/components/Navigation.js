      ...
      <List sx={{ flexGrow: 1, p: 2 }}>
        <StyledListItem>
          ...
          >
            <ListItemIcon sx={{ minWidth: 40, color: "text.secondary" }}>
              <ChatIcon
                color={activeTab === "Conversations" ? "primary" : "inherit"}
              />
            </ListItemIcon>
            <ListItemText
        ...
        <StyledListItem>
          ...
          >
            <ListItemIcon sx={{ minWidth: 40, color: "text.secondary" }}>
              <ChartIcon
                color={activeTab === "Statistics" ? "primary" : "inherit"}
              />
            </ListItemIcon>
            <ListItemText
              primary="Statistics"
        ...
        <StyledListItem>
          ...
          >
            <ListItemIcon sx={{ minWidth: 40, color: "text.secondary" }}>
              <PersonIcon
                color={
                  activeTab === "AgentConfiguration" ? "primary" : "inherit"
                }
              />
            </ListItemIcon>
            <ListItemText
        ...
        <StyledListItem>
          ...
          >
            <ListItemIcon sx={{ minWidth: 40, color: "text.secondary" }}>
              <CodeIcon
                color={activeTab === "APIModuleConfig" ? "primary" : "inherit"}
              />
            </ListItemIcon>
            <ListItemText
        ...
        <StyledListItem>
          ...
          >
            ...
            <ListItemText
              ...
              primaryTypographyProps={{
                color:
                  activeTab === "Settings" ? "primary.main" : "text.primary",
              }}
            />
          </ListItemButton>
        </StyledListItem>
